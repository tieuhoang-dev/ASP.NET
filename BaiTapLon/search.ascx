<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Search.ascx.cs" Inherits="BaiTapLon.Search" %>
...
<asp:Label ID="lblNoResults" runat="server" ForeColor="red" Font-Bold="true" Visible="false" Text="Không tìm thấy sách phù hợp." style="text-align:center; display:block; margin-bottom: 20px;" />
        ...
        <ItemTemplate>
            ...
            <div style="display: flex; border: 1px solid #ddd; padding: 10px; margin-bottom: 10px; border-radius: 6px;">
                <div style="flex: 0 0 100px;">
                    <img src='<%# ResolveUrl("~/Images/") + Eval("Hinh_minh_hoa") %>' alt="Hình sách" style="height: 140px; object-fit: cover; border-radius: 4px;" />
                </div>
